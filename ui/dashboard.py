...
class Ui_AdminDashboard(object):
    def setupUi(self, AdminDashboard):
        ...
        self.btn_add_employee = QtWidgets.QPushButton("SADD EMPLOYEE")
        ...
        return_layout = QtWidgets.QVBoxLayout(self.page_return)
        ...
        # Price (compulsory, disabled if auto-calculated, but enabled for input here)
        ...
        expenditure_layout = QtWidgets.QVBoxLayout(self.page_expenditure)
